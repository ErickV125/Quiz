...
submitBtn.addEventListener('click', () => {
    ...
    let imgSrcMeme=(score === 0)? "img/bob.png" : (score === (quizData.length*0.59))? "img/alesis1.png" : (score === (quizData.length*0.60))? "img/alesis2.png" : (score < (quizData.length*0.8))? "img/mrd.png" : (score === quizData.length)? "img/alber.png" : "img/pensar.png";
